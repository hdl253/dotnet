...
These assets are for the v2 release, updated for MVC 3 with Razor views and EF Code First.

The Content directory contains a stylesheet and images (you'll use these in section 3)
The Data directory contains a database (you'll add these in section 5)
